## Test case 2: Update transit_vpc's HA_GW size
...
aviatrix_ha_gw_size = "t2.small" # (optional) HA gw size. Mandatory if HA is enabled (ex. "t2.micro") ## UPDATED TO TEST THIS
