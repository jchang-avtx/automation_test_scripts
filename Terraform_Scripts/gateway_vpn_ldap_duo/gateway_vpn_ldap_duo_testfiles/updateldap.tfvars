...
## This is the section you're concerned with
         ...
         aviatrix_vpn_ldap_server = "1.2.3.4:567"
        aviatrix_vpn_ldap_bind_dn = "TESTTTTTTTTT\\Administrator"
       aviatrix_vpn_ldap_password = "myLDAPpassword456"
        aviatrix_vpn_ldap_base_dn = "DC=aviatrixfinal, DC=net"
aviatrix_vpn_ldap_username_attribute = "manual"
##############################################
