"""
run_aws_tgw_vpn_conn.py

Test case for Aviatrix's AWS TGW VPN Conn Terraform resource/ use-case
...
log.info("      2. Create AWS TGW VPN connections to TGW created from aws_tgw stage")
