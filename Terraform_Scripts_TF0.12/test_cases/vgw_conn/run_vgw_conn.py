...
Test case for AWS Virtual Private Gateway Connection Terraform resource/ use-case
...
log.info("      2. Create a connection between VGW and transit gateway")
log.info("      3. Perform terraform import to identify deltas")
log.info("      4. Perform update tests on transit gateway's CIDR advertisement")
