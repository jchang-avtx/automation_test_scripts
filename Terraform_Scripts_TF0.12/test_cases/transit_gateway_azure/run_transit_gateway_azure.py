"""
run_transit_gateway_azure.py

Test case for Azure Transit Gateway (Insane HA) Terraform resource/ use-case
...
log.info("      2. Create Azure transit gateway (Insane HA)")
