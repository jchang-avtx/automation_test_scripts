...
resource aviatrix_gateway aws_gw_test_1 {
  ...
  subnet              = aviatrix_vpc.aws_gw_vpc_1.public_subnets.0.cidr
  ...
  peering_ha_subnet   = aviatrix_vpc.aws_gw_vpc_1.public_subnets.1.cidr
...
resource aviatrix_gateway aws_gw_test_2 {
  ...
  gw_size             = "t2.micro"
  subnet              = aviatrix_vpc.aws_gw_vpc_2.public_subnets.0.cidr
  ...
  peering_ha_subnet   = aviatrix_vpc.aws_gw_vpc_2.public_subnets.1.cidr
  peering_ha_gw_size  = var.aws_ha_gw_size
