...
Test case for account (AWS using root credentials) Terraform resource/ use-case
...
secret_path = "/var/lib/jenkins/tf-secrets/account_root/"
cred_file = "aws_root_acc_cred"
...
log.info("      2. Create AWS account using root credentials")
log.info("      3. Identify deltas between created account")
