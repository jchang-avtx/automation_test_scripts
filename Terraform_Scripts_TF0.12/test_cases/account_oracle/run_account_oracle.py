"""
run_account_oracle.py

Test case for account (OCI) Terraform resource/ use-case
...
secret_path = "/var/lib/jenkins/tf-secrets/account_oracle/"
cred_file = "oracle_acc_cred"
...
log.info("      2. Create OCI account using credentials")
