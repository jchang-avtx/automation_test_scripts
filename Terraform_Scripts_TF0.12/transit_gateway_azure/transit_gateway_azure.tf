...
resource "aviatrix_transit_gateway" "azure_transit_gw" {
  ...
  subnet              = join(".", [random_integer.vnet1_cidr_int[0].result, random_integer.vnet1_cidr_int[1].result, "1.0/26"]) # "10.2.2.0/26"

  # ha_subnet           = "10.2.0.0/24" # non-insane
  ha_subnet           = join(".", [random_integer.vnet1_cidr_int[0].result, random_integer.vnet1_cidr_int[1].result, "1.64/26"]) # "10.2.2.64/26"
