...
#}
#module "arm-vnet" {
#	source 								= "./Regression_Testbed_TF_Module/modules/testbed-vnet-arm"
#	region 			 					= "East US"
#	vnet_count 						= 1
#	resource_name_label 	= local.resource_name_label
#  pub_hostnum						= local.pub_hostnum
...
#
#module "testbed-csr" {
#  source          	    = "./Regression_Testbed_TF_Module/modules/testbed-csr"
#  providers = {
#    aws = aws.csr
#  }
#  vpc_count	        	= 1
...
#  source                = "./Regression_Testbed_TF_Module/modules/testbed-aviatrix-accounts"
